                            ...
                            },
                            {
                                onMatch: function (e, t, n) {
                                    ...
                                    if (e[0] == "'" || e[0] == '"')
                                        e = e.slice(1, -1);
                                    return (
                                        n.unshift(this.next, e), "markup.list"
                                    );
                                },
                                regex: /<<<(?:\w+|'\w+'|"\w+")$/,
                                next: "heredoc",
        ...
        function (e, t, n) {
            ...
            (function () {
                (this.getCompletions = function (e, t, n, r) {
                    ...
                    if (s(i, "variable"))
                        return this.getVariableCompletions(e, t, n, r);
            ...
            r.inherits(c, i),
                function () {
                    (this.foldingRules = "cStyle"),
                        ...
                        (this.getNextLineIndent = function (e, t, n) {
                            var r = this.$getIndent(t),
                                i = this.getTokenizer().getLineTokens(
                                    t,
                                    e
                                ).tokens;
        ...
        function (e, t, n) {
            ...
            var y = function (e) {
                if (e && e.inline) {
                    var t = new g();
                    return (
                        (t.createWorker = this.createWorker),
                        (t.inlinePhp = !0),
                        t
                    );
                }
